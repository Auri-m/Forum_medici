...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;700;900&family=Mulish:wght@300;400;500;600&display=swap"
        rel="stylesheet">
    <style>
        *,
        *::before,
...
<body>
    ...
    <section class="hero">
        <div class="hero-text">
            ...
            <p>MedicoForum è lo spazio dedicato ai professionisti della salute per scambiarsi casi clinici, aggiornarsi
                sulle ultime ricerche e costruire reti professionali solide.</p>
            <div class="hero-cta">
        ...
        <div class="hero-visual">
            ...
            <div class="img-card img-sm2">
                <img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=300&q=80"
                    alt="Consulto medico">
            </div>
    ...
    <section class="section" id="features">
        ...
        <p class="section-sub">Dalla gestione dei casi clinici alla formazione continua, strumenti pensati per chi
            lavora in corsia ogni giorno.</p>

        <div class="features-grid">
            <div class="feat-card">
                <div class="feat-icon">🩺</div>
                <h3>Casi Clinici</h3>
                <p>Pubblica e discuti casi complessi con colleghi di tutta Italia. Ottieni un secondo parere in pochi
                    minuti.</p>
            </div>
            <div class="feat-card">
                <div class="feat-icon">📚</div>
            ...
            <div class="feat-card">
                ...
                <p>Connettiti con specialisti, trova collaborazioni e costruisci la tua rete professionale nel settore
                    sanitario.</p>
            </div>
            <div class="feat-card">
                <div class="feat-icon">🔒</div>
                <h3>Ambiente Sicuro</h3>
                <p>Piattaforma verificata. Solo medici con iscrizione all'Ordine possono accedere ai contenuti
                    riservati.</p>
            </div>
            <div class="feat-card">
                <div class="feat-icon">📊</div>
                <h3>Statistiche & Dati</h3>
                <p>Dashboard personali con insight sul tuo contributo alla community e sull'andamento delle discussioni.
                </p>
            </div>
            <div class="feat-card">
                <div class="feat-icon">🔔</div>
                <h3>Notifiche Smart</h3>
                <p>Ricevi aggiornamenti personalizzati sulle tue specializzazioni e non perdere mai una discussione
                    rilevante.</p>
            </div>
        </div>
    </section>
