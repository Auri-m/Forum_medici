  ...
  <style>
    ...
    *::after {
    ...
    header {
      ...
      padding: 0 5%;
      gap: 20px;
      animation: navDown .5s cubic-bezier(.22, 1, .36, 1) both;
    ...
    .nav-logo .cross {
      ...
      font-weight: 900;
      flex-shrink: 0;
      box-shadow: 0 4px 12px rgba(15, 159, 142, .3)
    }
    ...
    .big-avatar {
      ...
      height: 48px;
      border-radius: 50%;
      background: linear-gradient(135deg, var(--teal), #4fc3c3);
    ...
    .complete-fill {
      height: 100%;
      background: linear-gradient(to right, var(--teal), #4fc3c3);
      border-radius: 100px;
      width: 72%
    }
    ...
    .feed-tab.active {
      background: var(--navy);
      color: #fff;
      box-shadow: 0 2px 8px rgba(13, 31, 60, .2)
    }
    ...
    .new-post-box:hover {
      border-color: var(--teal);
      box-shadow: 0 4px 20px rgba(15, 159, 142, .1)
    }
    ...
    .new-post-box:hover .new-post-placeholder {
      border-color: rgba(15, 159, 142, .3);
      background: #f7fbfa
    }
    ...
    .fab:hover {
      transform: translateY(-2px);
      box-shadow: 0 10px 36px rgba(15, 159, 142, .5)
    }
    ...
    .filter-drawer {
      ...
      background: var(--white);
      z-index: 301;
      box-shadow: 8px 0 48px rgba(13, 31, 60, .12);
